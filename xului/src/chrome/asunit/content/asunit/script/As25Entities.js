...
var As25Entities = function() {
	this.init();
}

As25Entities.prototype = new Object();
As25Entities.prototype.items;

As25Entities.prototype.getItems = function() {
	return this.items;
}

As25Entities.prototype.init = function() {
	...
	this.items.push(new StubEntity("IME", "System.IME"));
